...
sortedList.each { buildFile ->
	...
	//builderMigration
	builderMigration.generateLanguageConfigurationYaml(langQualifier, langQualifier, dependencySearch, [assembler_SQLTranslator,assembler_CICSTranslator,assembler,debugSideFile,linkEdit])
